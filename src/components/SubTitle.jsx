...
export default function SubTitle({ firstTitle, secondTitle }) {
  return (
    <div className="w-full h-[60px] bg-red-700 flex justify-center items-center sticky top-0 z-10">
      <div className="w-full max-w-7xl flex items-center text-white font-semibold">
        ...
        {/* 메인타이틀 */}
        <div className="w-52 px-8 flex items-center justify-between border-r-[1px] border-red-600">
          <h2 className="">{firstTitle}</h2>
          <div>
