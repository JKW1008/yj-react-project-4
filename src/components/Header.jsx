...
const GNB = [
  ...
  { mainTitle: "커뮤니티", subTitle: "Comunity", link: "/comunity" },
      ...
      <div className=" w-full flex justify-center px-layout-padding">
        <div className=" w-full flex justify-center relative">
          ...
          <div className="absolute left-0 h-full flex items-center">
            <LogoAsset width={"w-32"} />
          </div>
          {/* 오른쪽 상단 */}
          <div className="flex space-x-8 py-2 text-sm absolute top-0 right-0 items-center uppercase">
            <div>
              <SearchAsset />
            </div>
            <div>Home</div>
