export default function SubTitleImage() {
  return (
    <div
      className="relative w-full h-240p overflow-hidden bg-[url('https://images.unsplash.com/photo-1651420079042-c16bb74c2357?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1632&q=80')]
     bg-center bg-cover"
    >
