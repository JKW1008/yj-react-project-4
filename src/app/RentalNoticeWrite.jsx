...
export default function RentalNoticeWrite() {
  ...
  const table_class_input =
    "w-80 text-sm border border-neutral-300 focus:border-neutral-400 focus:ring-neutral-400 placeholder:text-neutral-300";

  return (
    <Layout>
      <SubTitle firstTitle={"관리자 모드"} secondTitle={"공지사항 글쓰기"} />
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <table className="w-full table_top">
            <tbody>
              ...
              <tr>
                <td className={`${table_class_td}`}>
                  <span className="text-red-500">*</span>글 작성
                </td>
                <td className={`${table_class_td}`}>
                  <textarea
